...
def train(
    ...
    for batch_idx, (images, targets) in enumerate(train_loader):
        #print('images', images.shape, 'targets', targets.shape) #images torch.Size([32, 3, 224, 224]) targets torch.Size([32])
        #print('images', images.type, 'targets', targets.type)
#images <built-in method type of Tensor object at 0x7f77e11e8dd0> targets <built-in method type of Tensor object at 0x7f766ab78350>
